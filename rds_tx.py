...
class rds_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.root_raised_cosine_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.root_raised_cosine(
                ...
                1,
                (160*11)))
        self.rds_encoder_0 = rds.encoder(0, 14, True, 'SFPC', 89.8e6,
        			True, False, 13, 3,
        			147, 'Welcome Vincent to the world of Roaches')

        self.rds_encoder_0.set_max_output_buffer(outbuffer)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(rds_gain)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(pilot_gain)
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_c(usrp_rate, analog.GR_COS_WAVE, 19000, 1, 0, 0)
        self.analog_fm_preemph_0_0 = analog.fm_preemph(fs=48e3, tau=(75e-6), fh=(-1.0))
        self.analog_fm_preemph_0 = analog.fm_preemph(fs=48e3, tau=(75e-6), fh=(-1.0))
        ...
        self.connect((self.analog_fm_preemph_0_0, 0), (self.rational_resampler_xxx_0_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_complex_to_imag_0, 0))
        ...
        self.connect((self.audio_source_0, 1), (self.analog_fm_preemph_0_0, 0))
        self.connect((self.blocks_complex_to_imag_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_complex_to_imag_0_0, 0), (self.gr_multiply_xx_1, 0))
        self.connect((self.blocks_complex_to_imag_0_0_0, 0), (self.blocks_multiply_const_vxx_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.gr_add_xx_1, 1))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.gr_multiply_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_complex_to_imag_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_complex_to_imag_0_0_0, 0))
        ...
        self.connect((self.root_raised_cosine_filter_0, 0), (self.gr_multiply_xx_0, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.analog_sig_source_x_0_1.set_sampling_freq(self.usrp_rate)
        self.gr_frequency_modulator_fc_0.set_sensitivity((2*math.pi*self.fm_max_dev/self.usrp_rate))
    ...
    def set_rds_gain(self, rds_gain):
        ...
        self.blocks_multiply_const_vxx_1.set_k(self.rds_gain)
    ...
    def set_pilot_gain(self, pilot_gain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.pilot_gain)
